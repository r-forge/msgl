...
public:
	...
	ObjectiveFunctionScalarMultiplication(sgl::numeric lambda, ObjectiveFunctionExpression<E> const& fun) :
...
public:
	...
	ObjectiveFunctionAddition(ObjectiveFunctionExpression<A> const& fun1, ObjectiveFunctionExpression<B> const& fun2) :
			fun1(fun1), fun2(fun2) {
	}
