...
public:
	...
	rObject(arma::u32 value, bool unprotect_on_destruction = true)
			: number_of_protects(1), unprotect_on_destruction(unprotect_on_destruction)
	{
	...
	rObject(arma::Mat < double > const& m, bool unprotect_on_destruction = true)
			: number_of_protects(2), unprotect_on_destruction(unprotect_on_destruction)
	{
	...
	rObject(arma::sp_mat const& m, bool unprotect_on_destruction = true)
			: number_of_protects(0), unprotect_on_destruction(unprotect_on_destruction)
	{
		exp = create_sparse_matrix_object(m, number_of_protects);
	}

	rObject(rList const& list, bool unprotect_on_destruction = true)
			: number_of_protects(2), unprotect_on_destruction(unprotect_on_destruction)
	{
	...
	SEXP create_sparse_matrix_object(arma::sp_mat const& spMat, arma::u32 & number_of_protects)
	{
